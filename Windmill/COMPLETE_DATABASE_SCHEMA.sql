...
-- 테스트용 데이터베이스 연결
INSERT INTO DEX.DATABASE_CONNECTION (CONNECTION_ID,DB_TYPE,HOST_IP,PORT,DATABASE_NAME,USERNAME,PASSWORD,JDBC_DRIVER_FILE,TEST_SQL,CONNECTION_POOL_SETTINGS,CONNECTION_TIMEOUT,QUERY_TIMEOUT,MAX_POOL_SIZE,MIN_POOL_SIZE,STATUS,LAST_CONNECTION_TEST,CONNECTION_TEST_RESULT,CREATED_BY,CREATED_TIMESTAMP,MODIFIED_BY,MODIFIED_TIMESTAMP) VALUES
	 ('test_db','DB2','192.168.219.124',50000,'SAMPLE','db2inst1','1234','jcc-11.5.0.0.jar','SELECT 1 FROM SYSIBM.SYSDUMMY1',NULL,15,600,10,2,'ACTIVE',NULL,NULL,'SYSTEM','2025-08-15 17:19:04.479395',NULL,'2025-08-15 17:19:04.479395');
