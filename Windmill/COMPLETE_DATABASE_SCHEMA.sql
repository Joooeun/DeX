...
-- 시스템 설정 (간단한 버전 - system.properties 마이그레이션용)
...
('SESSION_TIMEOUT', '600', '세션 타임아웃 (분 단위)'),
('DOWNLOAD_IP_PATTERN', '10.240.13.*', '다운로드 허용 IP 패턴 (* = 모든 IP 허용)');
