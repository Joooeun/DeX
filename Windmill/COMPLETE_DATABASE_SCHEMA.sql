...
INSERT INTO DEX.DATABASE_CONNECTION (CONNECTION_ID,DB_TYPE,HOST_IP,PORT,DATABASE_NAME,USERNAME,PASSWORD,JDBC_DRIVER_FILE,TEST_SQL,CONNECTION_POOL_SETTINGS,CONNECTION_TIMEOUT,QUERY_TIMEOUT,MAX_POOL_SIZE,MIN_POOL_SIZE,STATUS,MONITORING_ENABLED,MONITORING_INTERVAL,CREATED_BY,CREATED_TIMESTAMP,MODIFIED_BY,MODIFIED_TIMESTAMP) VALUES
	 ('test_db','DB2','192.168.219.116',50000,'SAMPLE','db2inst1','1234','jcc-11.5.0.0.jar','SELECT 1 FROM SYSIBM.SYSDUMMY1',NULL,15,600,10,2,'ACTIVE',TRUE,300,'SYSTEM',CURRENT TIMESTAMP,NULL,CURRENT TIMESTAMP);
