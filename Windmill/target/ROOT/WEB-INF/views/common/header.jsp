...
<body class="sidebar-mini skin-purple-light">
	<div class="wrapper">
		...
		<div class="content-wrapper" id="framebox">
			<iframe name="iframe" id="iframe" class="content-wrapper" style="margin: 0; width: 100%; border: none; overflow-x: hidden; overflow: auto;">
				<div class="content-wrapper" id="framebox"></div>
			</iframe>
		</div>